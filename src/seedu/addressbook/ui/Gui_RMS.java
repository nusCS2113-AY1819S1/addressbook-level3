...
/*public class Gui_RMS {
  ...
  /*  public static final int DISPLAYED_INDEX_OFFSET = 1;
    ...
    private final Logic_RMS logic_rms;

    private MainWindow_RMS_Menu mainWindow_rms;
    private String version;

    public Gui_RMS(Logic_RMS logic_rms, String version) {
    ...
    private MainWindow_RMS_Menu createMainWindow(Stage stage, Stoppable mainApp) throws IOException{
         ...
         */
    /*    loader.setLocation(Main.class.getResource("ui/mainwindow_rms.fxml"));

        stage.setTitle(version);
        stage.setScene(new Scene(loader.load(), INITIAL_WINDOW_WIDTH, INITIAL_WINDOW_HEIGHT));
        stage.show();
        MainWindow_RMS_Menu mainWindow_rms = loader.getController();
