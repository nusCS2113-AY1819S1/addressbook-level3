...
public class Messages {
    ...
    public static final String MESSAGE_APPOINTMENT_LISTED_OVERVIEW = "%1$d appointment of %1$d listed!";
    ...
    public static final String MESSAGE_CHANGE_PASSWORD = "Using storage file : %1fgdhghdfhdf$s";
