...
** Existing commands are adjusted to accommodate the changed Person class
** Unit tests and parser arguments are adjusted to cater to said changes
...
** Documentation:
*** Did some tweaks to organise contents of the Readme: https://github.com/CS2113-AY1819S1-F10-2/main/pull/12[#12] , https://github.com/CS2113-AY1819S1-F10-2/main/pull/17[#17] ,
