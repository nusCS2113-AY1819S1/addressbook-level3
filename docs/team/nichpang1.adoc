...
* *Minor enhancement*: added a history command that allows the user to view a list of commands that were executed previously.

* *Code contributed*: [https://nuscs2113-ay1819s1.github.io/dashboard/#=undefined&search=nic...ern&sort=displayName&since=2018-09-12&until=2018-11-13&timeframe=day&reverse=false&repoSort=true[Code]]
...
** Documentation:
*** Did some tweaks to organise existing contents of the Readme
** Tools:
*** Integrated travis-ci and auto-publishing
...
* “Running game v1.0” for the independent summer project module (CP2106). Link to the app store can be found [https://play.google.com/store/apps/details?id=com.NaCl[here]].
