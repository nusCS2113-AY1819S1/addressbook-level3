 ...
 ** The points redeemed must not be larger than the amounts of points the assigned member has
 ** If the redeemed discount is more than the original price, the points redeemed will be set back to the
 limit value where the price after discount is not less than 0.
