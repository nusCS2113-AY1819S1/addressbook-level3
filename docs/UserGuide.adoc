...
Format: `add NAME [p]p/PHONE_NUMBER [p]e/EMAIL [p]a/ADDRESS [t/TAG] [tt/TIMETABLE]...`
...
Adds an enrolled class to a person in the address book +
Format: `addClass INDEX ec/ENROLLED_CLASS`

Example:

* `addClass 1 ec/CS2113T`
