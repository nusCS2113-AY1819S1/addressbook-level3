...
Example: +
`addmenu Cheese Fries p/$3.50 type/sides t/newItem` +
...
`listmenutype main` +
`deletemenu 1` +
System deletes menu item in index 1 from the menu. +
`listmenutype main` +
`deletemenu 1` +
System deletes the menu item in index 1 from the menu. +
