...
.. Prerequisites: List all persons using the `list` command. Multiple persons in the list. Logged in as tutor/admin. No attendance for the person has been taken.
...
.. Prerequisites: List all persons using the `list` command. Multiple persons in the list. Logged in as tutor/admin. Attendance for person has been taken. 
.. Test case: `viewAttenPerson 1`. +
