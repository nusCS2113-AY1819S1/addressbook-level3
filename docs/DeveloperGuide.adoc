...
|`* *` |user |add meeting details with a person from the addressbook | have a record of future meetings
|`* *` |user |list the meeting details given a specific date | easily find the meetings I need
