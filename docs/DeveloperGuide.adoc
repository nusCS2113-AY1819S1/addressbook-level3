...
|`* *` |user with different types of contacts |categorise my contacts |search for relevant contacts more easily
|`* *` |user with different levels of contacts' activity |order my contacts by priority |easily access my commonly contacted and needed contacts
