...
. User requests to rename a specific existing tag in the list
. AddressBook requests for new tag name with the user
. AddressBook confirms the change of tag name with the user
. AddressBook changes the tag name.
+
Use case ends.
...
* 3a. The existing tag cannot be found.
** 3a1. AddressBook shows an error message.
+
Use case resumes at step 2.
