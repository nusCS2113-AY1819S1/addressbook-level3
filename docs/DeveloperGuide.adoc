...
. User enters the tag to be changed
. AddressBook prompts user for the new tag name
. User enters the new tag name
. Addressbook confirms the tag name with user
. Addressbook changes all tags of the name chosen with the new name entered 
+
Use case ends.
...
* 5a. There is no input by the user
** 5a1. AddressBook shows an error message.
+
Use case resumes at step 4.

* 6a. User declines the confirmation
+
Use case resumes at step 4.
